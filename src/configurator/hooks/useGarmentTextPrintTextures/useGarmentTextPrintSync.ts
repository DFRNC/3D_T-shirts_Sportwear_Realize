...
import { useGarmentNameTextPrintTextures, useGarmentNumberTextPrintTextures, useGarmentTestoTextPrintTextures } from '@configurator/hooks/useGarmentTextPrintTextures/useGarmentTextPrintTextures';
