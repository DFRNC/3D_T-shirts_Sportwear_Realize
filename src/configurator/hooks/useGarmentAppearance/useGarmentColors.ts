...
import type { useGarmentAppearanceRefs } from './useGarmentAppearanceRefs';

type garmentAppearanceRefsReturnType = ReturnType<typeof useGarmentAppearanceRefs>;

type useGarmentColorsOptionsType = {
  refs: Pick<garmentAppearanceRefsReturnType, 'logosTextureRef' | 'maskTexturesRef' | 'pendingFrameReapplyRef'>;
  invalidate: () => void;
};
