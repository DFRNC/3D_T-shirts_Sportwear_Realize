...
describe('resolveDesignCardPreviewSrc', () => {
  ...
  it('uses basketball design icons for basket products', () => {
    expect(resolveDesignCardPreviewSrc('Design 1', 'design_01', 'canotta_magik_basket')).toBe('/svg/design/basket/design_01.svg');
    expect(resolveDesignCardPreviewSrc('Design 8', 'design_08', 'malone_basket')).toBe('/svg/design/basket/design_08.svg');
  });
});
