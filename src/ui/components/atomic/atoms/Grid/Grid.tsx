...
const variantGrid = cva('grid', {
  variants: {
    variant: {
      ...
      catalog_dialog_grid: 'max-h-[calc(var(--viewport-height)-var(--header-height,0px)-140px)] grid-cols-3 gap-2 overflow-y-auto overscroll-contain pr-1',
      ...
      position_picker_grid:
        'grid max-h-[calc(var(--viewport-height)-var(--header-height,0px)-160px)] grid-cols-3 gap-3 overflow-y-auto overscroll-contain pr-1 max-sm:gap-2 sm:gap-4',
    },
  },
  defaultVariants: {
    variant: 'default',
