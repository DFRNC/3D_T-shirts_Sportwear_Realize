...
const dialogContentVariants = cva(
  'fixed top-[50%] left-[50%] z-50 flex flex-col overflow-hidden w-auto min-w-[320px] translate-x-[-50%] translate-y-[calc(-50%+var(--header-height,0px)/2)] h-full max-h-[calc((var(--viewport-height)-var(--header-height,0px))*0.8)]',
  {
    variants: {
      variant: {
        default: 'rounded-[8px]',
      ...
      size: {
        default: 'p-4 sm:p-10 w-[calc(100%-32px)] max-w-[1044px] max-h-[calc(var(--viewport-height)-var(--header-height,0px)-32px)]',
      },
      background: {
        default: 'bg-white',
      },
