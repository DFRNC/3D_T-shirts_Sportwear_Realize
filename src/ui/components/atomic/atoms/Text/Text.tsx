...
const variantText = cva('font-inter font-[400] leading-none', {
  variants: {
    variant: {
      ...
      checkout_summary_discount_title: 'text-[14px] font-bold leading-4 text-white max-xl:text-[12px]',
      checkout_summary_discount_subtitle: 'text-center text-[12px] font-medium leading-3.5 text-white max-xl:text-[11px]',
      checkout_summary_item_name_default: 'font-semibold text-[20px] leading-4 text-[#0A0A0A] max-xl:text-[16px]',
      checkout_summary_item_name_compact: 'font-semibold text-[16px] leading-4 text-[#0A0A0A]',
      checkout_summary_price_default: 'shrink-0 font-semibold text-[24px] leading-4 tracking-[-1px] text-[#0A0A0A] max-xl:text-[18px] max-xl:leading-none',
      checkout_summary_price_compact: 'shrink-0 font-semibold text-[18px] leading-none tracking-[-1px] text-[#0A0A0A]',
      checkout_summary_shipping_label_default: 'font-medium text-[16px] leading-4 text-[#0A0A0A] max-xl:text-[14px]',
      checkout_summary_shipping_label_compact: 'font-medium text-[14px] leading-4 text-[#0A0A0A]',
      checkout_summary_total_label_default: 'font-semibold text-[20px] leading-4 text-[#0A0A0A] max-xl:text-[16px]',
      ...
      checkout_summary_timeline_step_label: 'text-center text-[12px] leading-3 text-black max-xl:text-[11px] max-sm:text-[12px]',
      checkout_summary_timeline_step_date: 'text-center text-[11px] leading-3.5 text-[#71717A] max-xl:text-[10px] max-sm:text-[11px]',
