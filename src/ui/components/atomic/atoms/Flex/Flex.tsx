  ...
  variants: {
    variant: {
      ...
      header_configuration: cn(
        'flex items-center justify-center bg-transparent py-2 w-full min-w-0 pt-[var(--header-height,72px)]',
      ...
      checkout_content_column: 'min-w-0 w-full flex-col items-start justify-start gap-6 pt-9 max-sm:gap-4 max-sm:pt-4 max-sm:pb-4',
      ...
      checkout_product_layout: 'w-full flex-wrap items-start justify-start gap-5 max-sm:gap-3 max-[359px]:gap-2',
      checkout_product_details: 'min-w-50 flex-1 flex-col items-start justify-start gap-3 max-sm:w-full max-sm:min-w-0 max-sm:gap-2',
      checkout_product_quantity_row: 'gap-3 max-sm:w-full max-sm:justify-between',
      checkout_product_quantity_inner: 'gap-3',
      checkout_product_price_row_mobile: 'hidden max-sm:flex max-sm:w-full max-sm:items-center max-sm:gap-1',
      ...
      checkout_product_actions: 'w-full flex-wrap items-center justify-start gap-2',
