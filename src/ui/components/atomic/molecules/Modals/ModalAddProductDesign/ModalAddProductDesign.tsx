  ...
  return (
    <AtomDialog open={isOpen} onOpenChange={handleOpenChange}>
      <AtomDialogContent
        ...
        aria-label={title}
        className="h-auto max-h-[calc(var(--viewport-height)-var(--dialog-safe-top)-32px)] w-full max-w-95 gap-5 max-sm:min-w-0 max-sm:max-w-[calc(100%-32px)] max-sm:gap-4 max-sm:p-5"
