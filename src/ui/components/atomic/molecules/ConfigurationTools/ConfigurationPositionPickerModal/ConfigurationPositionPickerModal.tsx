  ...
  return (
    <AtomDialog open={open} onOpenChange={onOpenChange}>
      <AtomDialogContent
        ...
        aria-label={title}
        className="h-auto max-h-[calc(var(--viewport-height)-var(--dialog-safe-top)-32px)] w-[calc(100%-32px)] min-w-0 max-w-155 gap-4 overflow-hidden p-4 pt-10 max-sm:gap-3"
