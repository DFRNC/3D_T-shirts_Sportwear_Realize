const garmentNumberMapFragment = /* glsl */ `
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[0], uNumberScale[0], uNumberGizmoHalf[0], 0.0, uNumberPartRotation[0], uNumberGizmoEnabled * uNumberGizmoFrameActive[0], numberInside0 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[1], uNumberScale[1], uNumberGizmoHalf[1], 0.0, uNumberPartRotation[1], uNumberGizmoEnabled * uNumberGizmoFrameActive[1], numberInside1 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[2], uNumberScale[2], uNumberGizmoHalf[2], 0.0, uNumberPartRotation[2], uNumberGizmoEnabled * uNumberGizmoFrameActive[2], numberInside2 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[3], uNumberScale[3], uNumberGizmoHalf[3], 0.0, uNumberPartRotation[3], uNumberGizmoEnabled * uNumberGizmoFrameActive[3], numberInside3 ) );

  vec4 numBtn0 = garmentGizmoButtons( vPrintUv, uNumberAnchorUv[0], uNumberScale[0], uNumberGizmoHalf[0], 0.0, uNumberPartRotation[0], uNumberGizmoEnabled * uNumberGizmoButtonsActive[0], uNumberGizmoButtonsReveal[0], numberInside0, uNameGizmoIcons, 0.0 );
  vec4 numBtn1 = garmentGizmoButtons( vPrintUv, uNumberAnchorUv[1], uNumberScale[1], uNumberGizmoHalf[1], 0.0, uNumberPartRotation[1], uNumberGizmoEnabled * uNumberGizmoButtonsActive[1], uNumberGizmoButtonsReveal[1], numberInside1, uNameGizmoIcons, 1.0 );
  vec4 numBtn2 = garmentGizmoButtons( vPrintUv, uNumberAnchorUv[2], uNumberScale[2], uNumberGizmoHalf[2], 0.0, uNumberPartRotation[2], uNumberGizmoEnabled * uNumberGizmoButtonsActive[2], uNumberGizmoButtonsReveal[2], numberInside2, uNameGizmoIcons, 2.0 );
  vec4 numBtn3 = garmentGizmoButtons( vPrintUv, uNumberAnchorUv[3], uNumberScale[3], uNumberGizmoHalf[3], 0.0, uNumberPartRotation[3], uNumberGizmoEnabled * uNumberGizmoButtonsActive[3], uNumberGizmoButtonsReveal[3], numberInside3, uNameGizmoIcons, 3.0 );
