const garmentTestoMapFragment = /* glsl */ `
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uTestoAnchorUv[0], uTestoScale[0], uTestoGizmoHalf[0], uTestoRotation[0], uTestoPartRotation[0], uTestoGizmoEnabled * uTestoGizmoFrameActive[0], testoInside0 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uTestoAnchorUv[1], uTestoScale[1], uTestoGizmoHalf[1], uTestoRotation[1], uTestoPartRotation[1], uTestoGizmoEnabled * uTestoGizmoFrameActive[1], testoInside1 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uTestoAnchorUv[2], uTestoScale[2], uTestoGizmoHalf[2], uTestoRotation[2], uTestoPartRotation[2], uTestoGizmoEnabled * uTestoGizmoFrameActive[2], testoInside2 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uTestoAnchorUv[3], uTestoScale[3], uTestoGizmoHalf[3], uTestoRotation[3], uTestoPartRotation[3], uTestoGizmoEnabled * uTestoGizmoFrameActive[3], testoInside3 ) );

  vec4 testoBtn0 = garmentGizmoButtons( vPrintUv, uTestoAnchorUv[0], uTestoScale[0], uTestoGizmoHalf[0], uTestoRotation[0], uTestoPartRotation[0], uTestoGizmoEnabled * uTestoGizmoButtonsActive[0], uTestoGizmoButtonsReveal[0], testoInside0, uNameGizmoIcons, 0.0 );
  vec4 testoBtn1 = garmentGizmoButtons( vPrintUv, uTestoAnchorUv[1], uTestoScale[1], uTestoGizmoHalf[1], uTestoRotation[1], uTestoPartRotation[1], uTestoGizmoEnabled * uTestoGizmoButtonsActive[1], uTestoGizmoButtonsReveal[1], testoInside1, uNameGizmoIcons, 1.0 );
  vec4 testoBtn2 = garmentGizmoButtons( vPrintUv, uTestoAnchorUv[2], uTestoScale[2], uTestoGizmoHalf[2], uTestoRotation[2], uTestoPartRotation[2], uTestoGizmoEnabled * uTestoGizmoButtonsActive[2], uTestoGizmoButtonsReveal[2], testoInside2, uNameGizmoIcons, 2.0 );
  vec4 testoBtn3 = garmentGizmoButtons( vPrintUv, uTestoAnchorUv[3], uTestoScale[3], uTestoGizmoHalf[3], uTestoRotation[3], uTestoPartRotation[3], uTestoGizmoEnabled * uTestoGizmoButtonsActive[3], uTestoGizmoButtonsReveal[3], testoInside3, uNameGizmoIcons, 3.0 );
