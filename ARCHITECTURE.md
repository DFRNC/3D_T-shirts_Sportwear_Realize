...
└── (application)/
    ├── layout.tsx                      # <body> shell
    ├── (scrollable)/                   # min-h-dvh, free scroll
    │   ├── layout.tsx                  # Header + main
    │   ├── (default_pages)/          # Home + Footer
    │   │   ├── page.tsx
    │   │   └── uv-debug/page.tsx
    │   └── checkout/page.tsx           # → CheckoutPage from @pages
    └── configurator/
        ├── layout.tsx                  # h-dvh viewport-locked shell
